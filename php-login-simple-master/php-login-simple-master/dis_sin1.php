...
<head>
<title>Cancha Sintetica 1</title>
<meta charset="utf-8">
...
<div class="wrapper row2">
  <section id="ctdetails" class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading font-x2" style="color: #efb810">Canchas Sinteticas #1</h6>
        <form action="dis_foot.php" method="POST">
        ...
        <table border="1">
            ...
            if ($inc){
                $consulta="SELECT * FROM sintetica1";
