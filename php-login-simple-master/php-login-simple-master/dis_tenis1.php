...
<div class="wrapper row2">
  <section id="ctdetails" class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading font-x2" style="color: #efb810">Canchas de Tenis #1</h6>
        <form action="dis_tenis1.php" method="POST">
